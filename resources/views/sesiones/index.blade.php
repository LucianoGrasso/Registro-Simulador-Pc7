                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-3 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider w-24">
                                        Mapa
                                    </th>
                                </tr>
                            </thead>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-4 whitespace-nowrap text-right">
                                            @if($sesion->archivo_vuelo)
                                                <a href="{{ route('vuelos.show', $sesion->archivo_vuelo) }}" 
                                                class="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white p-1.5 rounded-md shadow-sm transition-colors"
                                                title="Ver Mapa">
