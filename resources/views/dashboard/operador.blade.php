                    ...
                    <div class="grid grid-cols-7 gap-2">
                        @foreach($estadisticasSemana as $dia)
                            <div class="text-center">
                                <div class="text-xs text-gray-500 mb-1">{{ $dia['dia'] }}</div>
                                <div class="text-xs text-gray-700 mb-2">{{ $dia['fecha'] }}</div>
                                <div class="bg-red-100 rounded-lg p-2 min-h-16">
                                    <div class="text-sm font-medium text-red-900">{{ $dia['sesiones'] }}</div>
                                    <div class="text-xs text-red-600">sesiones</div>
                                    @if($dia['minutos'] > 0)
            ...
            function actualizarDashboard() {
                fetch('{{ route("dashboard.datos") }}')
                    ...
                    .then(data => {
                        ...
                        console.log('Dashboard operador actualizado:', data.timestamp);
                    })
