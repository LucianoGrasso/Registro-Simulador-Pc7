        ...
        <div class="flex justify-between h-20">
            ...
            <div class="hidden sm:flex sm:items-center sm:gap-4">
                ...
                <div class="flex items-center gap-2">
                    <span class="text-xs px-3 py-1.5 rounded-full whitespace-nowrap {{ auth()->user()->isAdmin() ? 'bg-yellow-100 text-yellow-800' : (auth()->user()->role === 'instructor' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800') }}">
                        {{ auth()->user()->isAdmin() ? '👑 Admin' : (auth()->user()->role === 'instructor' ? '👨‍✈️ Instructor' : '👤 Operador') }}
                    </span>
                </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-700">
            <div class="px-4">
                ...
                <div class="text-xs mt-1">
                    <span class="px-2 py-1 rounded-full {{ auth()->user()->isAdmin() ? 'bg-yellow-100 text-yellow-800' : (auth()->user()->role === 'instructor' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800') }}">
                        {{ auth()->user()->isAdmin() ? '👑 Administrador' : (auth()->user()->role === 'instructor' ? '👨‍✈️ Instructor' : '👤 Operador') }}
                    </span>
                </div>
            </div>
